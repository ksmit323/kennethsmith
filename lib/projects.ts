...
export const projects: ProjectType[] = [
  ...
  },
  {
    ...
    description: "An EVM L1 Proof-of-Authority private chain that tokenized real estate properties with governance features. I implemented the Governance protocol with Solidity and connected those contracts to the backend with GO bindings. Also developed the API for interacting with the MongoDB database.",
  ...
  },
  {
    ...
    slug: "ai-marketplace",
    description: "Developed the backend API to connect the frontend to synchronize with blockchain data. A.I. models used bonding curves to set prices.",
  ...
  },
  {
    ...
    title: "NFT P2E Game",
    slug: "nft-game",
    description: "Hackathon-winning project. Blockchain-based game on the EVM where players stake NFTs to earn ERC20 tokens. Developed smart contracts and frontend.",
  ...
  },
  {
    ...
    description: "Hackathon-winning project. Arbitraged funding rates across different DEXs for perpetual contracts.",
  ...
  },
  {
    ...
    description: "A trading bot designed to provide liquidity on the Cube Exchange. Hackathon finalist and presenter at Vietnam's biggest crypto event.",
  ...
  },
  {
    ...
    slug: "portfolio-blog",
    description: "A portfolio website for a professional developer with a focus on visual storytelling.",
  ...
  },
  {
    ...
    slug: "mobile-app-ui",
    description: "Developed a comprehensive UI design for an alcohol tracking mobile application using Dioxus Rust framework, focused on user experience.",
