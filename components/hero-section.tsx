      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <h3 className="text-2xl sm:text-3xl md:text-4xl font-medium text-muted-foreground h-[1.5em]">
            Build{" "}
            <span className="text-foreground border-r-2 border-primary animate-pulse pr-1">
              {displayText}
            </span>
          </h3>

          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Fullstack developer specializing in blockchain technology, building secure backend API's
